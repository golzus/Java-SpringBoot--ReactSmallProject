...
//     // שליפת רשימת הפרסומות מהשרת
//     fetch("http://localhost:8080/advertisement/byVisits/")
...
// }, [advertisements]);
//   console.log(advertisements, "dd");
// console.log(imagePathArr,"imagepath");
//   return (
...
//         )}
//         {imagePathArr[0] && <img src={imagePathArr[0]} className="adv" />}
//       </div>
...
//         )}
//         {imagePathArr[1] && <img src={imagePathArr[1]} className="adv" />}
//       </div>
...
//         )}
//         {imagePathArr[2] && <img src={imagePathArr[2]} className="adv" />}
...
//         )}
//         {imagePathArr[3] && <img src={imagePathArr[3]} className="adv" />}
...
const AdvertisementsPage = () => {
  ...
  const fetchAdvertisements = async () => {
    try {
      const response = await fetch("http://localhost:8080/advertisement/byVisits/");
    ...
    <div className="AdvertisementsContent">
      <div>
        {!imagePathArr[0] ? (
          ...
          <img src={imagePathArr[0]} alt="Advertisement Lower Right" className="adv" />
        )}
      </div>
      ...
      <div>
        {!imagePathArr[1] ? (
          ...
          <img src={imagePathArr[1]} alt="Advertisement Lower Left" className="adv" />
        )}
      </div>
      ...
      <div>
        {!imagePathArr[2] ? (
          ...
          <img src={imagePathArr[2]} alt="Advertisement Upper Right" className="adv" />
        )}
      </div>
      ...
      <div>
        {!imagePathArr[3] ? (
          ...
          <img src={imagePathArr[3]} alt="Advertisement Upper Left" className="adv" />
        )}
      </div>
    </div>
  );
